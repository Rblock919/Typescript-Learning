...
let foobar: NumVal;
foobar = [1, 2, 3]; // okay
foobar = 1; // 2; // 3; // all okay
// foobar = 4; // not okay
// foobar = [1, 2, 3, 4] // not okay

// used to not work (chicken & the egg scenario)
type NumVall = 1 | 2 | 3 | NumArr;
type NumArr = NumVall[];
...
// note interfaces are limited to extending the javascript object type.
// you can't have an interface that describes just simply "number" or "string"
// think of it as interfaces can only describes things that have a prototype
